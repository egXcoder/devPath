...
class PanelsController extends Controller
{
    ...
    public function create($category_name)
    {
        ...
        return "Panel belongs To ".$category_name."Created Successfully";
    }
    ...
    public function edit($category_name,$panel_name)
    {
        ...
        return "Panel".$panel_name." belongs To ".$category_name."Edited Successfully";
    }
    ...
    public function destroy($category_name,$panel_name)
    {
        ...
        return "Panel".$panel_name." belongs To ".$category_name."deleted Successfully";
    }
}
